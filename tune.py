...
def objective(
    ...
    replay_include_last_factor = set_fixed_attr(trial, "replay_include_last_factor", 1)
    ...
    perturbation_decay = trial.suggest_float("perturbation_decay", 0.5, 1.0, step=0.1)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--agents", type=int, default=25, help="Number of parallel agent to train."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--safe", action="store_true", help="Whether to use a safe variant of agent."
    )
    ...
    parser.add_argument(
        "--timeout", type=int, default=3600 * 3, help="Optuna timeout (seconds)."
    )
    parser.add_argument(
